...
namespace Peanut {
    ...
    export class Helper {
        ...
        public static isValidDate(dateString : string, required = false) {
        ...
        public static getSelectedFiles(elementId: string) {
            let element : HTMLInputElement  = document.querySelector(elementId);
        ...
        public static endsWith(haystack: string, needle: string ) {
            if (!haystack) {
                return false;
            }
